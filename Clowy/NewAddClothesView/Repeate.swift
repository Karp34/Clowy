...
//    }
//    
//    func deleteFromStorage(clothId: String, completion: @escaping () -> ()) {
...
//    }
//    
//    func updateImage(clothId: String) {
//        deleteFromStorage(clothId: clothId) {
//            print("sterted")
//            self.addImageToStorage(fileName: clothId)
//        }
//    }
//}
//
...
//                        viewModel.updateImage(clothId: viewModel.cloth.id)
//                        viewModel.updateCloth(name: viewModel.cloth.name, image: viewModel.cloth.id, type: viewModel.cloth.type.rawValue, temp: tempNames, color: viewModel.cloth.color, isDefault: viewModel.cloth.isDefault)
